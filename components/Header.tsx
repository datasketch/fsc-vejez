  ...
  return (
    ...
    >
      <div className="u-container">
        <nav className="grid grid-cols-4 lg:grid-cols-12 gap-x-2.5 xl:gap-x-5 relative">
          <div className="absolute top-1 hidden lg:block">
            <Link
              href="/"
            >
          ...
          <ul className="col-span-4 lg:col-start-3 lg:col-end-11 xl:col-start-3 justify-center gap-x-[22px] xl:col-end-11 flex lg:justify-between lg:gap-x-10">
            <li>
              <Link
                className={clsx(
