        ...
        <div className="rounded-t-[40px]">
            <div className="grid grid-cols-4 lg:grid-cols-12 gap-5 mx-10 lg:mx-20">
                ...
                <div className="row-start-2 col-start-1 col-span-3 mt-11">
                    <h3 className="text-3xl font-medium">Frecuencia de uso de internet y acceso a <span className="italic text-dark-slate-gray font-normal">dispositivos</span></h3>
                </div>
