    ...
    return (
        <>
            {/* <div className="relative top-0">
                <div>
                    <img src="/images/paper-green.svg" alt="paper-green" />
                </div>
                <div className="absolute z-10">
                    <img src="/images/paper-pink.svg" alt="paper-pink" />
                </div>
            </div> */}
            <div className="bg-banner-two-home bg-cover bg-no-repeat absolute z-10 top-[63rem] pt-24 pb-10 h-[754px]">
